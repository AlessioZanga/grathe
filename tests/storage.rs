...
mod undirected {
    macro_rules! generic_tests {
        ($G: ident) => {
            ...
            #[test]
            fn partial_cmp() {
                // Test `$G::<i32>::partial_cmp(G) -> Option<Ordering>`.
            ...
            #[test]
            fn new() {
                // Test `$G::<i32>::new(I: IntoIter<Item = i32>, I: IntoIter<Item = (i32, i32)>) -> Self`.
            ...
            #[test]
            fn empty() {
                // Test `$G::<i32>::empty(I: IntoIter<Item = i32>) -> Self`.
            ...
            #[test]
            fn complete() {
                // Test `$G::<i32>::complete(I: IntoIter<Item = i32>) -> Self`.
            ...
            #[test]
            fn adjacents_iter() {
                // Test `$G::<i32>::adjacents_iter(i32) -> Self`.
            ...
            #[test]
            fn has_vertex() {
                // Test `$G::<i32>::has_vertex(i32) -> bool`.
            ...
            #[test]
            fn add_vertex() {
                // Test `$G::<i32>::add_vertex(i32) -> bool`.
            ...
            #[test]
            fn del_vertex() {
                // Test `$G::<i32>::del_vertex(i32) -> bool`.
            ...
            #[test]
            fn has_edge() {
                // Test `$G::<i32>::has_edge(i32, i32) -> bool`.
            ...
            #[test]
            fn add_edge() {
                // Test `$G::<i32>::add_edge(i32, i32) -> bool`.
            ...
            #[test]
            fn del_edge() {
                // Test `$G::<i32>::del_edge(i32, i32) -> bool`.
